...
// Biến thể vô hiệu hoá dùng `data-disabled:`, KHÔNG phải `disabled:`: Base UI
// render <span role="checkbox" data-disabled aria-disabled> chứ không phải
// <input disabled>, nên `disabled:` của shadcn gốc không bao giờ khớp và ô bị
// khoá trông y hệt ô bình thường (phát hiện 27/07 ở sidebar lọc /tours).
// Nếu vendor lại từ upstream, giữ nguyên chỗ này.
