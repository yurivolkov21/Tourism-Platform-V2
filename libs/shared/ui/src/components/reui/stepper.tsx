...
function Stepper({
  ...
  const registerTrigger = useCallback((node: HTMLButtonElement | null) => {
    setTriggerNodes((prev) => {
      // Chỉ node thật mới vào mảng nên nhánh gỡ với node null của bản gốc là
      // no-op (`includes(null)` không bao giờ true) — viết lại không cần
      // non-null assertion, hành vi giữ nguyên.
  ...
  // Keyboard navigation logic — bọc useCallback (vá Biome: các hàm này nằm
  // trong deps của useMemo context bên dưới, bản gốc tạo mới mỗi render).
