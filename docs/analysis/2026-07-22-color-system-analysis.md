# Hệ màu — nguồn gốc, phương pháp đo, và các giá trị đã chốt

> **Bản ghi phân tích**, không phải luật. Chốt 22/07/2026 cùng user sau 6 vòng
> demo trực quan; tách khỏi `conventions/color-system.md` ngày 21/09/2026 vì
> đây là chuyện *đã đo thế nào*, còn luật đang thi hành thì ở lại bên kia.
>
> Giá trị máy-đọc-được là `@tourism/tokens` — **nguồn sự thật khi hai bên
> lệch**. Số trong file này là số đo tại thời điểm chốt, không đuổi theo code.
>
> Luật còn hiệu lực rút ra từ đây: [conventions/color-system.md](../conventions/color-system.md).
