...
| P3b — nối API bước 4: cụm Destinations + xoá lệch mock | [2026-07-31-destinations-api-design](specs/2026-07-31-destinations-api-design.md) | 🚧 spec chờ duyệt — trọn gói lệch-nhìn-thấy (2 trang destinations + Home + /about + navbar 19 điểm + moments sửa slug); sau branch này `mocks/tours.ts`/`mocks/destinations.ts` chết hẳn; rủi ro lớn nhất: layout fetch (navbar) chạm mọi route |
