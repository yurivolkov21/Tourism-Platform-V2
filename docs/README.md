...
| P3b — nối API bước 4: cụm Destinations + xoá lệch mock | [2026-07-31-destinations-api-design](specs/2026-07-31-destinations-api-design.md) | ✅ **merge 03/08** (`30fe3f9`, 10 commit, net −1.028 dòng) — 24/24 link tour 200 toàn site, mocks catalogue khai tử trọn. ⚠️ Spec §1E/§4.3 ĐÃ AMEND (Task 6 navbar moot — premise sai, user tái xác nhận 4-link 30/07); 3 quyết định hiển thị của user ghi [CHANGELOG 03/08](CHANGELOG.md) |
...
| [Bước 4: cụm Destinations lên API + xoá lệch mock](plans/2026-07-31-destinations-api.md) | 7 task theo [spec 31/07](specs/2026-07-31-destinations-api-design.md): lib/regions sang VM → /destinations → 3 trang vùng (reviews compose per-tour) → Home + moments hết link chết → /about → navbar 19 điểm (⚠️ layout fetch — có điều khoản DỪNG) → khai tử mocks/tours + destinations + nghiệm thu "0 link tour chết toàn site" | ✅ **merge 03/08**, 6/7 task + T6 moot; 3 vòng fix đều là lớp "số thật vs số bịa"; final review bắt 2 seam xuyên trang | 
