...
| P3b — nối API bước 1: cụm Blog + nền `lib/api` | [2026-07-31-blog-api-design](specs/2026-07-31-blog-api-design.md) | 🚧 spec chờ duyệt — seed 9 bài từ mock đã duyệt (sections → markdown), nền `lib/api` theo [ADR-0016](adr/0016-web-data-layer.md), đổi nguồn `/blog` + `/blog/[slug]` + rss + sitemap + teaser Home (điểm mới cần xác nhận), bảng shape-gap mock ↔ contract |
