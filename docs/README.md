...
| P3b — nối API bước 5+6: form Contact + Newsletter + unsubscribe | [2026-08-03-contact-newsletter-api-design](specs/2026-08-03-contact-newsletter-api-design.md) | 🚧 spec chờ duyệt — hai bề mặt GHI đầu tiên, browser-direct (throttle per-IP theo ADR-0016); ⚠️ quyết định user 03/08: **sonner Toaster toàn site** (bề mặt visual mới); trang unsubscribe khuôn utility + noindex; honeypot 2 form; nghiệm thu đo cả 429 throttle + vòng unsubscribe/resubscribe bằng token thật |
