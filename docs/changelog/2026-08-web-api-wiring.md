# CHANGELOG — lưu trữ: nối web vào API (30/07–07/08/2026)

Bảy bước nối 19 trang tĩnh của P3b vào API thật: blog, catalogue, điểm đến, form
liên hệ, bản tin, trang auth, khu tài khoản. Cộng luồng đặt chỗ, bản đồ MapLibre
và hai màn quay về từ cổng thanh toán.
