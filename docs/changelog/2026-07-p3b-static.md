# CHANGELOG — lưu trữ: P3b web tĩnh (22/07–28/07/2026)

Tách khỏi [`../CHANGELOG.md`](../CHANGELOG.md) ngày 03/08/2026 — DI CHUYỂN nguyên văn, 0 ký tự đổi.
⚠️ File này có 4 dòng bắt đầu bằng `+` là PHÉP CỘNG bị ngắt dòng (bẫy formatter,
xem CLAUDE.md §Gotchas) — ĐỪNG mở-rồi-save bằng editor có markdownlint: MD004 sẽ
đổi `+` thành `-` và nói sai con số test đã ghi.
