...
// Giao ước giá trị (sentinel All + tiền tố `v:`) sống ở `kit/filter-value.ts`
// từ vòng vá review polish 2 — re-export để consumer cũ không gãy.
export { fromFreeValue, toFreeValue } from '@/components/kit/filter-value';
