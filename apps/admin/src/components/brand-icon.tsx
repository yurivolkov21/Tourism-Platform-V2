...
// PORT NGUYÊN từ apps/web/src/components/brand-icon.tsx — cùng lý do logo được
// chép sang admin: hai app không chung package component, và favicon của hai
// app phải là MỘT hình.
 ...
 * vuông nền primary — đọc rõ trên cả thanh tab sáng lẫn tối.
 *
