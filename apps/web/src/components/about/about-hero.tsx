...
export function AboutHero() {
  return (
    <section className="relative flex min-h-screen w-full items-center overflow-hidden text-on-media">
      ...
      {/* Bố cục full-bleed pad mép (KHÔNG container giữa) — đã thử bản
          .container-gym kiểu forged ở §1 lần 2, user so hai bản và chọn bản
          gốc này (lần 3). Đừng "sửa lại cho giống forged" nữa. */}
