...
// About §7 — convert ShadcnSpace CTA 01 "Gradient Banner" (demo theo review:
// user nghiêng CTA 02 video nhưng muốn xem 01 trước): card bo 3xl viền nổi
// giữa trang, nền "aurora" blur-3xl qua pseudo-before — token hóa: xanh trời→
// jade primary, hổ phách→vàng nắng --region-spark (mặc định brand, hợp lệ
// ADR-0013 #4). Điểm đắt nhất: nút MORPH — viên tròn mũi tên hover trượt từ
// phải sang trái + xoay 45°, chữ đảo chiều padding. Icon @iconify → lucide,
// motion vào theo spring nhà.
