...
export const tours: TourFixture[] = [
  ...
  {
    id: 'd0000002-0000-4000-8000-000000000030',
    slug: 'con-dao-history-nature-3d',
    title: 'Côn Đảo History & Nature 3D2N',
    summary:
      "Turtle-nesting beaches and coral reefs above a colonial-era prison island — Côn Đảo's history and nature in three unhurried days.",
    categoryId: 'b0000001-0000-4000-8000-000000000002',
    durationDays: 3,
    maxGroupSize: 12,
    basePrice: '389.00',
    ...
    included: [
      ...
      'Breakfast daily',
      'Côn Đảo Prison entrance with guide',
      'Snorkelling gear and boat to Hòn Bảy Cạnh',
      'English-speaking guide',
    ],
    excluded: [
      'Domestic flights to/from Côn Đảo',
      'Lunches & dinners',
      'Turtle-watch night boat (seasonal, extra fee)',
    ],
    highlights: [
      'Côn Đảo Prison, including the "tiger cages"',
      'Hàng Dương Cemetery at dusk, incense for Võ Thị Sáu',
      'Đầm Trâu beach, one of the quietest in Vietnam',
      'Snorkelling the reefs off Hòn Bảy Cạnh',
      'Seasonal turtle-nesting watch (Jun–Sep, subject to season)',
    ],
    meetingPoint: 'Arrival pickup at Côn Đảo Airport',
    factDurationNote: 'Three days split between the prison museum and the empty beaches.',
    factGroupSizeNote: 'Twelve places, limited by the flights the island can take.',
    factDifficultyNote: 'Short walks and a boat leg; the heat is the harder part.',
    factGoodForNote: 'For travellers who want the history as much as the sand.',
...
export const tourDestinations: TourDestinationFixture[] = [
  ...
  {
    tourId: 'd0000002-0000-4000-8000-000000000030',
    destinationId: 'c0000002-0000-4000-8000-000000000019',
    isPrimary: true,
  },
];
...
export const tourItineraryDays: TourItineraryDayFixture[] = [
  ...
  // ---- Tour #30 — Côn Đảo History & Nature 3D2N ----
  {
    id: 'f0000002-0000-4000-8000-000000000216',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    dayNumber: 1,
    title: "Arrival and the prison's history",
    description: [
      '09:00 — Arrival at Côn Đảo Airport, buffer for baggage and pickup',
      '10:30 — Transfer to hotel, check-in',
      '12:00 — Lunch, own arrangement',
      '14:00 — Côn Đảo Prison tour, including the "tiger cages"',
      '16:30 — Côn Sơn town waterfront, free time',
      '18:00 — Hàng Dương Cemetery at dusk, incense for Võ Thị Sáu',
    ].join('\n'),
  },
  {
    id: 'f0000002-0000-4000-8000-000000000217',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    dayNumber: 2,
    title: 'Reefs and the quiet beach',
    description: [
      '07:30 — Breakfast, boat transfer to Hòn Bảy Cạnh',
      '08:30 — Snorkelling the coral reefs off the island',
      '11:00 — Return to Côn Sơn, lunch',
      '13:30 — Đầm Trâu beach, swim and free time',
      '16:30 — Ma Thiên Lãnh viewpoint hike (short, moderate)',
      '19:00 — Seafood dinner, own arrangement',
    ].join('\n'),
  },
  {
    id: 'f0000002-0000-4000-8000-000000000218',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    dayNumber: 3,
    title: 'Last morning and departure',
    description: [
      '07:30 — Breakfast, check-out',
      '08:30 — An Sơn Temple visit, free time',
      '10:30 — Transfer to Côn Đảo Airport, buffer before flight',
      '12:00 — Departure flight to Sài Gòn (own arrangement)',
    ].join('\n'),
  },
];
...
export const tourFaqs: TourFaqFixture[] = [
  ...
  // ---- Tour #30 ----
  {
    id: 'd2000002-0000-4000-8000-000000000232',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    order: 1,
    question: 'When is turtle-nesting season?',
    answer:
      'Roughly June–September, peaking around the full moon; the night watch is seasonal and subject to ranger availability, so it is not guaranteed on every departure.',
  },
  {
    id: 'd2000002-0000-4000-8000-000000000233',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    order: 2,
    question: 'Is the prison tour appropriate for children?',
    answer:
      'The history is heavy (the "tiger cages" and wartime displays) — appropriate for older children with parental guidance, less so for young kids.',
  },
  {
    id: 'd2000002-0000-4000-8000-000000000234',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    order: 3,
    question: 'How tight is the flight connection to the island?',
    answer:
      "Book your own Sài Gòn–Côn Đảo flight (~1h) with at least 1.5 hours' buffer at both airports — flights are limited and delays are not unusual on this route.",
  },
  {
    id: 'd2000002-0000-4000-8000-000000000235',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    order: 4,
    question: 'Do I need snorkelling experience?',
    answer:
      'No — the reef at Hòn Bảy Cạnh is shallow and calm; a short briefing and life jacket are enough for first-timers.',
  },
];
...
export const tourPolicies: TourPolicyFixture[] = [
  ...
  // ---- Tour #30 ----
  {
    id: 'd3000002-0000-4000-8000-000000000225',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    kind: 'CANCELLATION',
    order: 1,
    title: 'Free until 10 days out',
    body: 'Cancel 10 or more days before departure for a full refund; 50% is refunded 5-10 days out; inside 5 days or a no-show, the fare is forfeited, as flights and hotel rooms to the island are booked in limited numbers.',
  },
  {
    id: 'd3000002-0000-4000-8000-000000000226',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    kind: 'BOOKING',
    order: 2,
    title: '30% deposit secures your seats',
    body: 'A 30% deposit secures your seats on this limited-capacity departure; the balance is due 10 days before departure.',
  },
  {
    id: 'd3000002-0000-4000-8000-000000000227',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    kind: 'GENERAL',
    order: 3,
    title: 'Book your island flight early',
    body: 'Book your own Sài Gòn–Côn Đảo flight early — seats are limited; allow at least 1.5 hours at the airport on both ends.',
  },
];
...
export const tourDepartures: TourDepartureFixture[] = [
  ...
  // ---- Tour #30 ----
  {
    id: 'e0000002-0000-4000-8000-000000000234',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    startDate: '2026-09-19',
    endDate: '2026-09-21',
    priceOverride: null,
  ...
  {
    id: 'e0000002-0000-4000-8000-000000000235',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    startDate: '2026-10-24',
    endDate: '2026-10-26',
    priceOverride: '339.00',
  ...
  {
    id: 'e0000002-0000-4000-8000-000000000236',
    tourId: 'd0000002-0000-4000-8000-000000000030',
    startDate: '2026-12-05',
    endDate: '2026-12-07',
    priceOverride: null,
